...
const PLAYER_STATISTIC_MAX_RATING_INDEX = 2;
const PLAYER_STATISTIC_MIN_RATING_INDEX = 3;
const PLAYER_STATISTIC_WON_MATCH_COUNT_INDEX = 4;
const PLAYER_STATISTIC_DRAW_MATCH_COUNT_INDEX = 5;
const PLAYER_STATISTIC_LOST_MATCH_COUNT_INDEX = 6;
const PLAYER_STATISTIC_MATCH_COUNT_INDEX = 7;
const PLAYER_STATISTIC_MATCH_RATIO_INDEX = 8;
const PLAYER_STATISTIC_FORM_INDEX = 9;

const GLOBAL_STATISTIC_MATCH_COUNT_INDEX = 1;
const GLOBAL_STATISTIC_PLAYER_COUNT_INDEX = 2;
const GLOBAL_STATISTIC_GOAL_COUNT_INDEX = 3;
const GLOBAL_STATISTIC_AVERAGE_GOAL_COUNT_INDEX = 4;
const GLOBAL_STATISTIC_MAX_GOAL_COUNT_INDEX = 5;
const GLOBAL_STATISTIC_MIN_GOAL_COUNT_INDEX = 6;
const GLOBAL_STATISTIC_MAX_GOAL_COUNT_BY_TEAM_INDEX = 7;
const GLOBAL_STATISTIC_MIN_GOAL_COUNT_BY_TEAM_INDEX = 8;
const GLOBAL_STATISTIC_MAX_MATCH_COUNT_BY_PLAYER_INDEX = 9;
const GLOBAL_STATISTIC_BIGGEST_VICTORY_INDEX = 10;
const GLOBAL_STATISTIC_MAX_RATING_INDEX = 11;
const GLOBAL_STATISTIC_AVERAGE_RATING_INDEX = 12;
